...
//Having DetectionOnly and Correction options (Atena)
  ...
  ///////(3rd solution)
  //////logic [3:0] correction_end_index;
  ...
  always_comb begin
    ...
    case(corr_state_q)
        ...
        CORRECTING: begin
          ...
          /////(3rd solution) Add a done_flag to track last active correction(Atena)
          /////Track the highest-index error at start, not just the lowest
          /////defining correction_end_index at the start of a correction pass
          //////if (correction_index == correction_end_index )
          ...
          /////but if an entry be corrupted which has already been passed, counter continue counting and wrapping to reach the corrupted one
           ...
           /// (1st solution)start counting from smallest index and continue till entry 15

           //if (correction_index == TLB_ENTRIES - 1)
...
/////(3rd solution) Add a done_flag to track last active correction
/////Track the highest-index error at start, not just the lowest
 ////defining correction_end_index at the start of a correction pass
...
//////////////////////////////////////////////
    ...
    for (int unsigned i = 0; i < TLB_ENTRIES; i++) begin
      ...
      // Correct single-bit errors in TLB tags
                   ...
                   if(i == correction_index && invalidate_tag[i] == 2'b01)begin  //////(for updating tags_n in case of having 1 bit error_Atena)
