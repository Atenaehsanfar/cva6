...
//Having DetectionOnly and Correction options (Atena)
  ...
  ///////////////////////////////////// (Atena)
   initial begin
    $display("[DEBUG] DetectionOnly = %0d at time %0t", DetectionOnly, $time);
  end
  ////////////////////////////////////////
  ...
  always_comb begin
    ...
    case(corr_state_q)
        ...
        CORRECTING: begin
          ...
          /////start counting from smallest index and continue till last corrupted and then go to IDLE;
...
logic [TLB_ENTRIES-1:0] already_invalidated;
