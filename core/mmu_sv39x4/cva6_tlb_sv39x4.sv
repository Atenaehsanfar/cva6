...
//////////ae/arbiter-ecc-modifiedCriticalPath//////Atena
...
////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////// Adding logics for arbiter (Atena)
// Request signal to arbiter: 1-bit per TLB entry, set to 1 if the corresponding entry has a 1-bit ECC error
  logic [TLB_ENTRIES-1:0] rr_req;
// One-hot grant output from arbiter indicating which entry is selected for correction in this cycle
  logic  rr_req_o;

// Index of the currently selected entry to be corrected (generated by arbiter)
  logic [$clog2(TLB_ENTRIES)-1:0] rr_idx;
...
// //////////////////////////////////////////////////////////////////
 ...
 ////////////////////////Check for 1-bit error and creation a vector of those (Atena)
...
rr_arb_tree #(
  ...
  .rst_ni  (rst_ni),
  .flush_i (1'b0),            // unused
  .req_i   (rr_req),          // which entries are requesting correction
  .rr_i    ('0),
  .req_o   (rr_req_o),        // only one-hot signal returned by arbiter
  .data_i  ('0),              // not used
  .data_o  (),                // not used
  .gnt_i   ('1),              // always granting to selected
  .gnt_o   (),
  .idx_o   (rr_idx)           // index of selected entry
);
