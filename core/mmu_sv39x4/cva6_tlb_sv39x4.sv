...
//Having DetectionOnly and Correction options (Atena)
 ...
 ////////////////////////////////////////////////////////
  ...
  logic [3:0] correction_index; ///index generated by the counter module to select which entry to check each cycle
...
//////////////////////////////////////////////
    ...
    for (int unsigned i = 0; i < TLB_ENTRIES; i++) begin
      ...
      // Correct single-bit errors in TLB tags & contents (Atena)

          else if (!DetectionOnly) begin
                   if(i == correction_index)begin
